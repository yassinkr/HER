...
const SideBar = ({firstName, LastName }) => {
  ...
  return (
    <div className='px-5 fixed bottom-0 w-full h-16 lg:left-0 lg:top-0 text-white text-center text-lg font-Bodoni bg-herDarkBrown lg:w-fit lg:h-full lg:py-10 flex flex-row lg:flex-col justify-between lg:justify-start items-center'>
        <ul className=' lg:h-72 flex flex-row w-full lg:flex-col justify-between lg:justify-between items-center'>
          <li className="flex flex-col justify-center items-center lg:mx-3 cursor-pointer order-5 lg:order-1"><div className="lg:mx-5 lg:pt-5 lg:pb-20 lg:w-16"><div className='flex justify-center items-center'><svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
<image id="image0_558_162" width="48" height="48" xlinkHref="data:image/png;base64,"/>
 ...
 <p className='hidden lg:block' >{firstName}<br></br>{LastName}</p>
</div></li>
           <li className="flex flex-col justify-center items-center lg:mx-3 cursor-pointer" onClick={()=>handleClick("/")}>
            <div><svg width="35" height="35" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.4 18V11.6471H12.6V18H17.85V9.52941H21L10.5 0L0 9.52941H3.15V18H8.4Z" fill="white"/>
</svg></div>
<p className='hidden lg:block'>Home</p></li>
           <li className="flex flex-col justify-center items-center cursor-pointer" onClick={()=>handleClick("/Myprofile/products/Liste")}>
            <div><svg width="30" height="30" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
</svg></div><p className='hidden lg:block'>Products</p></li>
...
</div><p className='hidden lg:block'>Orders</p></li>
           <li className="flex flex-col justify-center items-center cursor-pointer" onClick={()=>handleClick("/")}>
            <div><svg width="30" height="30" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg></div><p className='hidden lg:block'>Sittings</p></li> 
        </ul>
    </div>
  )
}
