...
const SideBar = ({firstName, LastName }) => {
  ...
  return (
    <div className='px-5 fixed bottom-0 w-full h-16 md:left-0 md:top-0 text-white text-center text-lg font-Bodoni bg-herDarkBrown md:w-fit md:h-full md:py-10 flex flex-row md:flex-col justify-between md:justify-start items-center'>
        <ul className=' md:h-[600px] flex flex-row w-full md:w-16 md:flex-col justify-between items-center'>
          <li className="flex flex-col justify-center items-center md:mx-3 cursor-pointer order-5 md:order-first "><div className=" md:pt-5 md:pb-12 md:w-16"><div className='flex justify-center items-center'><svg width="41" height="40" viewBox="0 0 41 40" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
<image id="image0_558_162" width="48" height="48" xlinkHref="data:image/png;base64,"/>
 ...
 <p className='hidden md:block' >{firstName}<br></br>{LastName}</p>
</div></li>
           <li className="flex flex-col justify-center items-center md:mx-3 cursor-pointer" onClick={()=>handleClick("/")}>
...
<p className='hidden md:block'>Home</p></li>
...
</svg></div><p className='hidden md:block'>Products</p></li>
...
</div><p className='hidden md:block'>Orders</p></li>
           <li className="flex flex-col justify-center items-center cursor-pointer" onClick={()=>handleClick("/")}>
